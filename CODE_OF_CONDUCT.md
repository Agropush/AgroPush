...
requests, discussions, code review) and when an individual is officially
representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainers by opening a confidential report via a
GitHub issue marked private where supported, or by contacting a maintainer
directly (see [CONTRIBUTING.md](./CONTRIBUTING.md) for current maintainer
contacts). All complaints will be reviewed and investigated promptly and
fairly.
